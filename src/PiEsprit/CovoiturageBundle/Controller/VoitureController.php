...
class VoitureController extends Controller
{
    ...
    public function showAction(Voiture $voiture)
    {
        ...
        return $this->render('@PiEspritCovoiturage/voiture/show.html.twig', array(
            'voiture' => $voiture,
    ...
    {
        $deleteForm = $this->createDeleteForm($voiture);
        $editForm = $this->createForm('PiEsprit\CovoiturageBundle\Form\VoitureType', $voiture);
        ...
        return $this->render('@PiEspritCovoiturage/voiture/edit.html.twig', array(
            'voiture' => $voiture,
